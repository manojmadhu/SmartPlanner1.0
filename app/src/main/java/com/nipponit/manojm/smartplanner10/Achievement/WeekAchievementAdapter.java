...
public class WeekAchievementAdapter extends ArrayAdapter<WeekAchievementClass> {
    ...
    public WeekAchievementAdapter(Context context, ArrayList<WeekAchievementClass> data) {
    ...
    public View getView(int position,View convertView, ViewGroup parent) {
        WeekAchievementClass weekmodel = getItem(position);
        ...
        viewHolder.txtprecentage.setText(weekmodel.getPrecentage_());
