...
public class View_CustomCustomerAchievementAdapter_target extends ArrayAdapter<View_CustomerAchievementClass_target> {

    private Context context;
    private ArrayList<View_CustomerAchievementClass_target> dataset;

    private ArrayList<View_CustomerAchievementClass_target> Original_List;
    private ArrayList<View_CustomerAchievementClass_target> Customer_List;
    ...
    private static class ViewHolder{
        ...
        TextView txtccity;
        TextView txtctarget;
        TextView txtcachievement;
    }

    public View_CustomCustomerAchievementAdapter_target(Context context, ArrayList<View_CustomerAchievementClass_target> data) {
        super(context,R.layout.view_customer_target_prototype,data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View_CustomerAchievementClass_target customerModel = getItem(position);
        ...
        if(convertView==null) {
            ...
            convertView = inflater.inflate(R.layout.view_customer_target_prototype, parent, false);
            ...
            viewHolder.txtcachievement=(TextView) convertView.findViewById(R.id.lblCus_achievement);
            ...
            viewHolder.txtcachievement.setTypeface(fonts.SetType("ubuntu-reg"));
        ...
        viewHolder.txtcachievement.setText(customerModel.getSale_());
    ...
    private class CustomerFilter extends Filter{
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint != null && constraint.toString().length() > 0 ){
                ArrayList<View_CustomerAchievementClass_target> filtered_list = new ArrayList<>();
                for(int i = 0, l = Original_List.size(); i < l; i++){
                    if((Original_List.get(i).getCname_().toUpperCase()).contains(constraint.toString().toUpperCase())){
                        View_CustomerAchievementClass_target customerAchievementClass_target = new View_CustomerAchievementClass_target(Original_List.get(i).getCcode_(),
                                Original_List.get(i).getCname_(),Original_List.get(i).getCcity_(),Original_List.get(i).getTarget_(),Original_List.get(i).getSale_());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            Customer_List = (ArrayList<View_CustomerAchievementClass_target>)results.values;
